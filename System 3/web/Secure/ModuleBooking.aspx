<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ModuleBooking.aspx.cs" Inherits="Secure_ModuleBooking" %>
            ...
            <td class="style6"
                ...
                <asp:ListBox ID="ListBoxModCodes" runat="server" 
                    ...
                    onselectedindexchanged="ListBox1_SelectedIndexChanged1" Width="100px" 
                        Rows="12" 
                        ToolTip="Please ensure you have selected a module code from the list." 
                        ondatabound="ListBoxModCodes_DataBound"></asp:ListBox>
                <asp:ListBox ID="ListBoxModNames" runat="server" 
                    ...
                    onselectedindexchanged="ListBox2_SelectedIndexChanged" Width="305px" Rows="12" 
                        ...
                        ondatabound="ListBoxModNames_DataBound">
                </asp:ListBox>
                </div>
