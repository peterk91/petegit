<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="edit.aspx.cs" Inherits="Secure_edit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    <strong>
    <div class="style4">
        <strong><em><span class="style3">Edit Request</span></em></strong>
    </div>
    </strong>
    ...
    <table 
        ...
        <tr>
            <td class="style6"
                ...
                <div class="style7" 
                        style="border: 1px solid #808080; width: 410px; vertical-align: middle; background-color: #FFFFFF;">
                ...
                <asp:ListBox ID="ListBoxModCodes" runat="server" 
                    ...
                    DataValueField="ModuleID" AutoPostBack="True" 
                    onselectedindexchanged="ListBox1_SelectedIndexChanged1" Width="100px" 
                        Rows="12"></asp:ListBox>
                <asp:ListBox ID="ListBoxModNames" runat="server" 
                    DataSourceID="SQLModNames" DataTextField="Name" DataValueField="ModuleID" 
                    AutoPostBack="True" 
                    onselectedindexchanged="ListBox2_SelectedIndexChanged" Width="300px" Rows="12">
                </asp:ListBox>
                </div>
                ...
                <strong>
                    <asp:TextBox ID="TextBoxStudents" runat="server" Width="50px" 
                        ...
                        ValidationGroup="CheckBookingForm" CausesValidation="True"></asp:TextBox>
            ...
            <td class="style6" style="padding: 10px" width="50%">
                <strong>
                <div style="text-decoration: underline">
    ...
    <span class="style2">
        ...
        RepeatColumns="4" 
            ...
            <td class="style9" 
                ...
                <div style="border: 1px solid #808080; text-align: center; background-color: #FFFFFF; height: 87%; width: 100%;">
                    <br />
                    <span class="style2">
    <asp:ListBox ID="RoomBox1" runat="server" DataSourceID="SQLRooms" 
        DataTextField="RoomID" DataValueField="RoomID" Width="107px" 
                        ...
                        ondatabound="RoomBox1_DataBound">
    </asp:ListBox>
    ...
    <asp:Button ID="Button1" runat="server" onclick="Button1_Click" 
        Text="Update Request" style="text-align: center; height: 26px;" 
                        ValidationGroup="CheckBookingForm" />
                </div>
            </td>
        </tr>
...
WHERE Round.[Open] &lt;= GETDATE() AND Round.[Close] &gt;= GETDATE()">
                ...
                <asp:DropDownList ID="DropDownList3" runat="server" 
                    ...
                    DataValueField="RoundID" 
                        ...
                        AutoPostBack="True" ondatabound="DropDownList3_DataBound" Visible="False">
                </asp:DropDownList>
                </div>
                </strong>
    <br />
