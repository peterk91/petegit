<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="rerequest.aspx.cs" Inherits="Secure_rerequest" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    <strong>
    <div class="style4">
        <strong><em><span class="style3">Try A Request Again</span></em></strong>
        <br />
        <br />
        Reason for denial:
    ...
    <asp:Button ID="Button1" runat="server" onclick="Button1_Click" 
        Text="Re Request" style="text-align: center" ValidationGroup="CheckBookingForm" />
                </div>
            </td>
        </tr>
    </table>
