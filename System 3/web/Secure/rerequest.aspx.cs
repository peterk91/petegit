...
public partial class Secure_rerequest : System.Web.UI.Page
{
    ...
    protected void rounddec()
    {
        ...
        if(roundname == "Ad hoc")
        {
            Label2.Text = "You are booking in Ad hoc mode, your request will be instantly allocated";
    ...
    protected void startup()
    {
        ...
        MyCommand = new System.Data.SqlClient.SqlCommand();
        MyCommand.Connection = MyConnection;
        MyCommand.CommandText = "SELECT ModuleID,NoStudents,NoRooms,RoundID,ParkOnly,BuildingID,Notes FROM Request WHERE (RequestID = " + RequestID + ")";
        MyDataReader = MyCommand.ExecuteReader();
        while (MyDataReader.Read())
        {
            ...
            Label1.Text = MyDataReader.GetSqlValue(6).ToString();
        }
        MyDataReader.Close();
        MyDataReader = null;
