<?php	
	...
	$stateSQL = 'SELECT * FROM Request WHERE UserID = "AndyW" AND RequestID NOT IN(SELECT RequestID FROM Denied) AND RequestID NOT IN(SELECT RequestID FROM Allocation) ORDER BY Date DESC';
