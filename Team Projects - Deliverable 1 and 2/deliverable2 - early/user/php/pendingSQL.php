<?php	
	...
	$stateSQL = 'SELECT * FROM Request WHERE UserID = "Pete" AND RequestID NOT IN(SELECT RequestID FROM Denied) AND RequestID NOT IN(SELECT RequestID FROM Allocation)';
