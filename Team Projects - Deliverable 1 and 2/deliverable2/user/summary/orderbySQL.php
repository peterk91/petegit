<!--this script orders the requests by what the user has requested and returns the
record to the parent for it to make a new list
...
<?php
	...
	while($row=mysql_fetch_array($result2)){
		...
		echo 'newrecord['.$count.']=record ; ';
		$count++;};

?>

makenewtable(newrecord,<?php echo '"'.$_REQUEST['table'].'"'; ?>)</script>